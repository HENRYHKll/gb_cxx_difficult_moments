...
// source: studentLib.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_studentLib_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_studentLib_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_studentLib_2eproto
...
struct TableStruct_studentLib_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_studentLib_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::studentLib::FullName* Arena::CreateMaybeMessage<::studentLib::FullName>(Arena*);
template<> ::studentLib::Student* Arena::CreateMaybeMessage<::studentLib::Student>(Arena*);
template<> ::studentLib::StudentsGroup* Arena::CreateMaybeMessage<::studentLib::StudentsGroup>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace studentLib {
...
class FullName final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:studentLib.FullName) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:studentLib.FullName)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_studentLib_2eproto;
};
// -------------------------------------------------------------------

class Student final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:studentLib.Student) */ {
 public:
  ...
  // .studentLib.FullName fullName = 1;
  bool has_fullname() const;
  private:
  bool _internal_has_fullname() const;
  public:
  void clear_fullname();
  const ::studentLib::FullName& fullname() const;
  PROTOBUF_NODISCARD ::studentLib::FullName* release_fullname();
  ::studentLib::FullName* mutable_fullname();
  void set_allocated_fullname(::studentLib::FullName* fullname);
  private:
  const ::studentLib::FullName& _internal_fullname() const;
  ::studentLib::FullName* _internal_mutable_fullname();
  public:
  void unsafe_arena_set_allocated_fullname(
      ::studentLib::FullName* fullname);
  ::studentLib::FullName* unsafe_arena_release_fullname();

  // int32 averageGrade = 3;
  void clear_averagegrade();
  int32_t averagegrade() const;
  void set_averagegrade(int32_t value);
  private:
  int32_t _internal_averagegrade() const;
  void _internal_set_averagegrade(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:studentLib.Student)
 private:
  class _Internal;
  ...
  ::studentLib::FullName* fullname_;
  int32_t averagegrade_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_studentLib_2eproto;
};
// -------------------------------------------------------------------
...
class StudentsGroup final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:studentLib.StudentsGroup) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "studentLib.StudentsGroup";
  }
  protected:
  ...
  // repeated .studentLib.Student students = 1;
  int students_size() const;
  private:
  int _internal_students_size() const;
  public:
  void clear_students();
  ::studentLib::Student* mutable_students(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::studentLib::Student >*
      mutable_students();
  private:
  const ::studentLib::Student& _internal_students(int index) const;
  ::studentLib::Student* _internal_add_students();
  public:
  const ::studentLib::Student& students(int index) const;
  ::studentLib::Student* add_students();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::studentLib::Student >&
      students() const;

  // @@protoc_insertion_point(class_scope:studentLib.StudentsGroup)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::studentLib::Student > students_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_studentLib_2eproto;
};
// ===================================================================
...
inline const std::string& FullName::surname() const {
  // @@protoc_insertion_point(field_get:studentLib.FullName.surname)
...
void FullName::set_surname(ArgT0&& arg0, ArgT... args) {
 ...
 surname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:studentLib.FullName.surname)
}
inline std::string* FullName::mutable_surname() {
  std::string* _s = _internal_mutable_surname();
  // @@protoc_insertion_point(field_mutable:studentLib.FullName.surname)
  return _s;
}
...
inline std::string* FullName::release_surname() {
  // @@protoc_insertion_point(field_release:studentLib.FullName.surname)
...
inline void FullName::set_allocated_surname(std::string* surname) {
  ...
  // @@protoc_insertion_point(field_set_allocated:studentLib.FullName.surname)
}
...
inline const std::string& FullName::name() const {
  // @@protoc_insertion_point(field_get:studentLib.FullName.name)
...
void FullName::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:studentLib.FullName.name)
}
inline std::string* FullName::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:studentLib.FullName.name)
  return _s;
}
...
inline std::string* FullName::release_name() {
  // @@protoc_insertion_point(field_release:studentLib.FullName.name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:studentLib.FullName.name)
}
...
inline const std::string& FullName::patronymic() const {
  // @@protoc_insertion_point(field_get:studentLib.FullName.patronymic)
...
void FullName::set_patronymic(ArgT0&& arg0, ArgT... args) {
 ...
 patronymic_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:studentLib.FullName.patronymic)
}
inline std::string* FullName::mutable_patronymic() {
  std::string* _s = _internal_mutable_patronymic();
  // @@protoc_insertion_point(field_mutable:studentLib.FullName.patronymic)
  return _s;
}
...
inline std::string* FullName::release_patronymic() {
  // @@protoc_insertion_point(field_release:studentLib.FullName.patronymic)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:studentLib.FullName.patronymic)
}
...
inline const ::studentLib::FullName& Student::_internal_fullname() const {
  const ::studentLib::FullName* p = fullname_;
  return p != nullptr ? *p : reinterpret_cast<const ::studentLib::FullName&>(
      ::studentLib::_FullName_default_instance_);
}
inline const ::studentLib::FullName& Student::fullname() const {
  // @@protoc_insertion_point(field_get:studentLib.Student.fullName)
...
inline void Student::unsafe_arena_set_allocated_fullname(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:studentLib.Student.fullName)
}
inline ::studentLib::FullName* Student::release_fullname() {
  
  ::studentLib::FullName* temp = fullname_;
  fullname_ = nullptr;
...
inline ::studentLib::FullName* Student::unsafe_arena_release_fullname() {
  // @@protoc_insertion_point(field_release:studentLib.Student.fullName)
  
  ::studentLib::FullName* temp = fullname_;
  fullname_ = nullptr;
  return temp;
}
inline ::studentLib::FullName* Student::_internal_mutable_fullname() {
  
  if (fullname_ == nullptr) {
    auto* p = CreateMaybeMessage<::studentLib::FullName>(GetArenaForAllocation());
    fullname_ = p;
  }
  return fullname_;
}
inline ::studentLib::FullName* Student::mutable_fullname() {
  ::studentLib::FullName* _msg = _internal_mutable_fullname();
  // @@protoc_insertion_point(field_mutable:studentLib.Student.fullName)
  return _msg;
}
inline void Student::set_allocated_fullname(::studentLib::FullName* fullname) {
  ...
  if (fullname) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::studentLib::FullName>::GetOwningArena(fullname);
  ...
  fullname_ = fullname;
  // @@protoc_insertion_point(field_set_allocated:studentLib.Student.fullName)
}
...
inline int32_t Student::grades(int index) const {
  // @@protoc_insertion_point(field_get:studentLib.Student.grades)
  return _internal_grades(index);
}
inline void Student::set_grades(int index, int32_t value) {
  grades_.Set(index, value);
  // @@protoc_insertion_point(field_set:studentLib.Student.grades)
}
...
inline void Student::add_grades(int32_t value) {
  ...
  // @@protoc_insertion_point(field_add:studentLib.Student.grades)
}
...
Student::grades() const {
  // @@protoc_insertion_point(field_list:studentLib.Student.grades)
...
Student::mutable_grades() {
  // @@protoc_insertion_point(field_mutable_list:studentLib.Student.grades)
...
inline int32_t Student::_internal_averagegrade() const {
  return averagegrade_;
}
inline int32_t Student::averagegrade() const {
  // @@protoc_insertion_point(field_get:studentLib.Student.averageGrade)
  return _internal_averagegrade();
}
inline void Student::_internal_set_averagegrade(int32_t value) {
  
  averagegrade_ = value;
}
inline void Student::set_averagegrade(int32_t value) {
  _internal_set_averagegrade(value);
  // @@protoc_insertion_point(field_set:studentLib.Student.averageGrade)
}
...
inline ::studentLib::Student* StudentsGroup::mutable_students(int index) {
  // @@protoc_insertion_point(field_mutable:studentLib.StudentsGroup.students)
  return students_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::studentLib::Student >*
StudentsGroup::mutable_students() {
  // @@protoc_insertion_point(field_mutable_list:studentLib.StudentsGroup.students)
  return &students_;
}
inline const ::studentLib::Student& StudentsGroup::_internal_students(int index) const {
  return students_.Get(index);
}
inline const ::studentLib::Student& StudentsGroup::students(int index) const {
  // @@protoc_insertion_point(field_get:studentLib.StudentsGroup.students)
  return _internal_students(index);
}
inline ::studentLib::Student* StudentsGroup::_internal_add_students() {
  return students_.Add();
}
inline ::studentLib::Student* StudentsGroup::add_students() {
  ::studentLib::Student* _add = _internal_add_students();
  // @@protoc_insertion_point(field_add:studentLib.StudentsGroup.students)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::studentLib::Student >&
StudentsGroup::students() const {
  // @@protoc_insertion_point(field_list:studentLib.StudentsGroup.students)
  return students_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_studentLib_2eproto
